...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="bg-white/10 dark:bg-black/10 backdrop-blur-lg sticky top-0 z-20 border-b border-white/20 dark:border-black/20">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            <p className="hidden sm:block text-sm text-gray-600 dark:text-gray-300">
             ...
             <div className="relative" ref={languageMenuRef}>
              ...
              {isLanguageMenuOpen && (
                <div className="absolute end-0 mt-2 w-40 bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-md shadow-lg ring-1 ring-black ring-opacity-5 py-1 z-50">
            ...
            <div className="relative" ref={profileMenuRef}>
                ...
                {isProfileMenuOpen && (
                    <div className="absolute end-0 mt-2 w-48 bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-md shadow-lg ring-1 ring-black ring-opacity-5 py-1 z-50">
