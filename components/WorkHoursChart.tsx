...
const WorkHoursChart: React.FC<WorkHoursChartProps> = ({ logs, profile, t, language }) => {
  ...
  if (chartData.length < 2) {
    return (
      <div className="bg-glass-bg-light dark:bg-glass-bg-dark backdrop-blur-xl border border-glass-border-light dark:border-glass-border-dark p-6 sm:p-8 rounded-2xl shadow-2xl shadow-shadow-color-light dark:shadow-shadow-color-dark w-full h-full flex flex-col items-center justify-center min-h-[380px]">
  ...
  return (
    <div ref={chartRef} className="relative bg-glass-bg-light dark:bg-glass-bg-dark backdrop-blur-xl border border-glass-border-light dark:border-glass-border-dark p-6 sm:p-8 rounded-2xl shadow-2xl shadow-shadow-color-light dark:shadow-shadow-color-dark w-full">
        <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">{t('recentWorkHours')}</h2>
