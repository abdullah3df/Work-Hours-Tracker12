...
const Toast: React.FC<ToastProps> = ({ toast, onRemove }) => {
  ...
  return (
    <div className="max-w-sm w-full bg-glass-bg-light dark:bg-glass-bg-dark backdrop-blur-lg shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden border border-glass-border-light dark:border-glass-border-dark">
      <div className="p-4">
