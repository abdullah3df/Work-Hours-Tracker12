...
const LogFormModal: React.FC<LogFormModalProps> = ({ isOpen, onClose, onSave, logToEdit, t, showToast, defaultType }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-[10001] p-4">
      <div className="bg-glass-bg-light dark:bg-glass-bg-dark backdrop-blur-xl border border-glass-border-light dark:border-glass-border-dark rounded-xl shadow-2xl w-full max-w-md">
